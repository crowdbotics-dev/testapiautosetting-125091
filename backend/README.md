...
## Project Structure
    ...
    ├── testapiautosetting_125091  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125091`
...
2. Clone this repo and `cd testapiautosetting_125091`
